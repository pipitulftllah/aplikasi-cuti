...
<head>
	...
	<title>Aplikasi Web Pengajuan Cuti Online Kecamatan Bogor Selatan - <?php echo $pagedesc ?></title>

	<link href="libs/images/kec.bosel.png" rel="icon" type="images/x-icon">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="../libs/images/kec.bosel.png" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>Kecamatan Bogor Selatan</strong></div>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							<h4>Aplikasi Web Pengajuan Cuti Online <br> <b>Kecamatan Bogor Selatan</b></h4>
                        ...
                        <!-- open <li> tag generated with php, see line 155-160 -->
							...
							<ul class="nav nav-second-level">
								<?php
									...
									if($pagedesc == "Menunggu Disetujui") {
										echo '<li><a href="cuti_waitapp.php" class="active">Menunggu Disetujui</a></li>';
									}
									else {
										echo '<li><a href="cuti_waitapp.php">Menunggu Disetujui</a></li>';
									}
